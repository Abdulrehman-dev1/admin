                                    ...
                                    <div class="nftmax-userprofile__content">
                                        ...
                                        <div class="nftmax-userprofile__info">
                                            ...
                                            <ul class="list-unstyled mt-2">
                                                <li><strong>UTM Source:</strong> {{ $user->utm_source ?? 'N/A' }}</li>
                                                <li><strong>UTM Medium:</strong> {{ $user->utm_medium ?? 'N/A' }}</li>
                                                <li><strong>UTM Campaign:</strong> {{ $user->utm_campaign ?? 'N/A' }}</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="nftmax-userprofile__right">
                                        <a href="#" class="nftmax-btn nftmax-btn__primary nftmax-btn__profile radius">Edit
                                            Profile</a>
                                ...
                                <div class="nftmax-pcats__bar">
                                    <div class="nftmax-pcats__list list-group " id="list-tab" role="tablist">
                                        <a class="list-group-item active" data-bs-toggle="list" href="#tab_1" role="tab"
                                            href="profile.html">Paid Invoices<span class="nftmax-pcats__count">16</span></a>
                                        <a class="list-group-item" data-bs-toggle="list" href="#tab_2" role="tab">Pending
                                            Invoices<span class="nftmax-pcats__count">09</span></a>
                                        <a class="list-group-item" data-bs-toggle="list" href="#tab_3" role="tab">Hold
                                            Invoices<span class="nftmax-pcats__count">35</span></a>
                                        <a class="list-group-item" data-bs-toggle="list" href="#tab_4" role="tab">Cancel
                                            Shippment<span class="nftmax-pcats__count">14</span></a>
                                        <a class="list-group-item" data-bs-toggle="list" href="#tab_5"
                                            role="tab">Dispute<span class="nftmax-pcats__count">21</span></a>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <table id="nftmax-table__main"
                                                    ...
                                                    <tbody class="nftmax-table__body">
                                                        ...
                                                        <tr>
                                                            <td colspan="6" class="nftmax-table__no-data">No bookings found.
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="col-12">
                                                <div class="nftmax-pptabs mg-btm-20">
                                                    <div class="nftmax-pptabs__form">
                                                        <form class="nftmax-header__form-inner nftmax-header__form-profile"
                                                            action="#">
                                                    ...
                                                    <div class="nftmax-pptabs__main">
                                                        <ul class="nav nav-tabs nftmax-dropdown__list" id="nav-tab"
                                                            ...
                                                            <li class="nav-item dropdown">
                                                                <a
                                                                    class="nftmax-sidebar_btn nftmax-heading__tabs nav-link dropdown-toggle">Recently
                                                                    Received <span><svg width="20" height="10"
                                                    ...
                                                    <div class="trending-action__body">
                                                        <div class="trending-action__author-meta">
                                                            <div class="trending-action__author-img"><img
                                                                    src="img/author-pic.png" alt="#"></div>
                                                            <p class="trending-action__author-name">Owned by <a
                                                                    href="profile.html">Bilout</a></p>
                                                        </div>
                                                        <h2 class="trending-action__title"><a
                                                                href="active-bids.html">Interconnected Planes</a></h2>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <div class="trending-action__single nftmax-pd-20">
                                                    ...
                                                    <div class="trending-action__body trending-marketplace__body">
                                                        <h2 class="trending-action__title"><a
                                                                href="marketplace-details.html">Interconnected Planes</a>
                                                        </h2>
                                                        <div class="nftmax-currency">
                                                            <div class="nftmax-currency__main">
                                                                <div class="nftmax-currency__icon"><img
                                                                        src="img/eth-icon.png" alt="#"></div>
                                                                <div class="nftmax-currency__content">
                                                                    <h4 class="nftmax-currency__content-title">75,320 ETH
                                                                    </h4>
                                                                    <p class="nftmax-currency__content-sub">(773.69 USD)</p>
                                                                </div>
                                                            </div>
                                                            <a href="#" class="nftmax-btn nftmax-btn__secondary radius">On
                                                                Sale</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-3 col-md-6 col-12">
                                                ...
                                                <div class="trending-action__single nftmax-pd-20">
                                                    ...
                                                    <div class="trending-action__body">
                                                        ...
                                                        <h2 class="trending-action__title"><a href="#">Interconnected
                                                                Planes</a></h2>
                                                        <div class="dashboard-banner__bid dashboard-banner__bid-v2">
                                                            <!-- Single Bid -->
                                                            <div class="dashboard-banner__group dashboard-banner__group-v2">
                                                    ...
                                                    <div class="dashboard-banner__button trending-action__bottom">
                                                        <a href="active-bids.html"
                                                            class="nftmax-btn nftmax-btn__secondary radius">Place a Bid</a>
                                                        <a href="marketplace.html" class="nftmax-btn trs-white">View Art
                                                            Work</a>
                                                    </div>
                                                </div>
                                                <!-- End Treadning Single -->
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <div class="trending-action__single nftmax-pd-20">
                                                    ...
                                                    <div class="trending-action__head">
                                                        ...
                                                        <img src="img/marketplace-1.png" alt="#">
                                                        <div class="trending-action__remove"><i
                                                ...
                                                <div class="nftmax-collection__single">
                                                    ...
                                                    <div class="nftmax-collection__body">
                                                        ...
                                                        <div class="nftmax-collection__author">
                                                            ...
                                                            <div class="nftmax-collection__item"><a href="#">324 Item</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="nftmax-collection__body">
                                                        ...
                                                        <div class="nftmax-collection__author">
                                                            <div class="nftmax-collection__author-head">
                                                                <a href="#">
                                                                    <img src="img/market-author-2.png" alt="#">
                                                                    <h4 class="nftmax-collection__title">Virtural Worlds
                                                                    </h4>
                                                                </a>
                                                            </div>
                                                            <div class="nftmax-collection__item"><a href="#">324 Item</a>
                                    ...
                                    <div class="tab-pane fade" id="tab_6" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="nftmax-table">
                                            ...
                                            <!-- NFTMax Table -->
                                            <table id="nftmax-table__main"
                                                class="nftmax-table__main nftmax-table__profile-activity">
                                                <!-- NFTMax Table Head -->
                                                <thead class="nftmax-table__head">
                                                    <tr>
                                                        <th class="nftmax-table__column-1 nftmax-table__h1">List</th>
                                                        <th class="nftmax-table__column-2 nftmax-table__h2">Products Name
                                                        </th>
                                                ...
                                                <tbody class="nftmax-table__body">
                                                    <tr>
                                                        ...
                                                        <td class="nftmax-table__column-5 nftmax-table__data-5">
                                                            <p class="nftmax-table__text nftmax-table__bid-text"><a
                                                                    href="#">Marvin McKinney</a></p>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="nftmax-table__column-2 nftmax-table__data-2">
                                                            <div class="nftmax-table__product">
                                                                ...
                                                                <div class="nftmax-table__product-content">
                                                                    <h4 class="nftmax-table__product-title">View Card by
                                                                        Jeff Davis</h4>
                                                                    <p class="nftmax-table__product-desc">Owned by <a
                                                                            href="#">Xoeyam</a></p>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="nftmax-table__column-2 nftmax-table__data-2">
                                                            <div class="nftmax-table__product">
                                                                ...
                                                                <div class="nftmax-table__product-content">
                                                                    <h4 class="nftmax-table__product-title">Spanky &amp;
                                                                        Friends</h4>
                                                                    <p class="nftmax-table__product-desc">Owned by <a
                                                                            href="#">Xoeyam</a></p>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="nftmax-table__column-2 nftmax-table__data-2">
                                                            <div class="nftmax-table__product">
                                                                ...
                                                                <div class="nftmax-table__product-content">
                                                                    <h4 class="nftmax-table__product-title">Intercnected
                                                                        Planes</h4>
                                                                    <p class="nftmax-table__product-desc">Owned by <a
                                                                            href="#">Xoeyam</a></p>
                                                                </div>
