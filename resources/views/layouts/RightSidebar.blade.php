        ...
        <div class="admin-menu">
            ...
            <div class="logo">
                <a href="{{ route('dashboard') }}">
                    <img class="nftmax-logo__main" width="120" height="80" src="{{ asset('images/header-logo.png') }}"
                        alt="#">
                </a>
            </div>
            <!-- Author Details -->
...
">
                        ...
                        @endcan
                        @role('admin')
                        <li class="{{ request()->routeIs('bids.*') ? 'active' : '' }}">
                            <a href="{{ route('bids.index') }}">
                                <span class="menu-bar__text">
                                    ...
                                    <span class="menu-bar__name">Bids</span>
                                </span>
                            </a>
                        </li>
                        @endrole
        ...
        <a href="{{ route('identities.index') }}">
			...
			<span class="nftmax-menu-icon nftmax-svg-icon__v1">
                ...
                <span class="menu-bar__name">Identity </span>
                        ...
                        @can('individual-verification-list')
                        ...
                        @endcan
                        @can('corporate-verification-list')
                                    ...
                                    <span class="nftmax-menu-icon nftmax-svg-icon__v1">
                                        <svg class="nftmax-svg-icon" xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            <path
                                                d="M0.800781 2.60005V7.40005H7.40078V0.800049H2.60078C2.12339 0.800049 1.66555 0.989691 1.32799 1.32726C0.990424 1.66482 0.800781 2.12266 0.800781 2.60005H0.800781Z" />
                                            <path
                                                d="M13.4016 0.800049H8.60156V7.40005H15.2016V2.60005C15.2016 2.12266 15.0119 1.66482 14.6744 1.32726C14.3368 0.989691 13.879 0.800049 13.4016 0.800049Z" />
                                            <path
                                                d="M0.800781 13.4001C0.800781 13.8775 0.990424 14.3353 1.32799 14.6729C1.66555 15.0105 2.12339 15.2001 2.60078 15.2001H7.40078V8.6001H0.800781V13.4001Z" />
                                            <path
                                                d="M8.60156 15.2001H13.4016C13.879 15.2001 14.3368 15.0105 14.6744 14.6729C15.0119 14.3353 15.2016 13.8775 15.2016 13.4001V8.6001H8.60156V15.2001Z" />
            ...
            <div class="admin-menu__two mg-top-50">
                ...
                <div class="menu-bar">
                    <ul class="menu-bar__one">
                        ...
                        <li><a href="users/1/edit"><span class="menu-bar__text"><span
                    ...
                    <div class="nftmax-preview__close">
                        ...
                        <div class="nftmax__item-button--group">
                            <button class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius"
                                type="button"><a href="{{ url('/logout') }}">Yes Logout</a></button>
