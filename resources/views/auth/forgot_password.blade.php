...
<div class="body-bg" style="background-image:url('{{ asset('img/body-bg.jpg') }}')">
    <!-- NFTMax Welcome -->
    <section class="nftmax-wc nftmax-wc-bg nftmax-wc__full">
                ...
                <div class="col-xxl-6 col-lg-6 col-12 nftmax-hidden-rp">
                    <div class="nftmax-wc__inner nft-gr-primary">
                        ...
                        <div class="nftmax-wc__middle">
                            <a href="{{ url('/') }}"><img src="{{ asset('img/welcome-vector.png') }}" alt="#"></a>
                        </div>
                        <!-- Welcome Heading -->
                ...
                <div class="col-xxl-6 col-lg-6 offset-lg-0 col-md-8 offset-md-2 col-12">
                    ...
                    <div class="nftmax-wc__form">
                        <div class="nftmax-wc__form-inner">
                            <div class="nftmax-wc__heading">
                                <h3 class="nftmax-wc__form-title nftmax-wc__form-title__three" style="background-image:url('{{ asset('img/heading-vector-3.png') }}')">Forgot Password</h3>
                            </div>
                            <!-- Forgot Password Form -->
                            <form class="nftmax-wc__form-main" action="{{ route('password.email') }}" method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="nftmax-wc__button">
                                        <button class="ntfmax-wc__btn" type="submit">Send Password Reset Link</button>
                                    </div>
                                </div>
                            </form>
