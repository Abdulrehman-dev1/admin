...
<div class="panel-body form-auth-style" id="app">
        	...
        	<div class="row">
                ...
                <div class="col-xs-6">  
                    ...
                    <form method="POST" action="https://onlineauctionscript.digisamaritan.com/sms/send" accept-charset="UTF-8" name="formValidate" class="ng-pristine ng-valid"><input name="_token" type="hidden" value="qa0uN1j9m2pZK139vZSpGbz4PDAldy3mIv11N4So">


                 <div class="form-group">

                    <label for="sms_to" class="control-label">SMS To</label>

                    <span class="text-red">*</span>

                   
                        <select class="form-control select2 select2-hidden-accessible" required="true" multiple="" ng-class="{&quot;has-error&quot;: formValidate.users.$touched &amp;&amp; formValidate.users.$invalid}" name="users[]" tabindex="-1" aria-hidden="true"><option value="3">seller</option><option value="4">bidder</option><option value="12">michale</option><option value="13">jack</option><option value="14">test</option><option value="15">smith</option><option value="16">john</option><option value="17">werwer</option><option value="29">Ande</option><option value="32">Manohar</option><option value="33">Sai</option></select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 515px;"><span class="selection"><span class="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1"><ul class="select2-selection__rendered"><li class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" placeholder="" style="width: 0.75em;"></li></ul></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>


                    
                        <div class="validation-error ng-inactive" ng-messages="formValidate.users.$error">
                    ...
                    <div class="form-group">
                        ...
                        <label for="message_template" class="control-label">Message</label>

                       
                        <textarea class="form-control" placeholder="Message" ng-maxlength="200" required="true" ng-class="{&quot;has-error&quot;: formValidate.message.$touched &amp;&amp; formValidate.message.$invalid}" name="message" cols="50" rows="10"></textarea>


                        
                        <div class="validation-error ng-inactive" ng-messages="formValidate.message.$error">
                     ...
                     <div class="form-group pull-right">
                            ...
                            <button class="btn btn-success" ng-disabled="!formValidate.$valid">Send SMS</button>
