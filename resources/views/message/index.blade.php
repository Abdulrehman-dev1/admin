...
<div class="col-md-12">
    ...
    <div class="row" style="margin-top:15px;">
        ...
        <div class="col-xs-3">
            <a href="https://onlineauctionscript.digisamaritan.com/messenger/create" class="btn btn-primary btn-group-justified">New Message</a>

            <div class="list-group" style="margin-top:8px;">
                <a href="https://onlineauctionscript.digisamaritan.com/messenger" class="list-group-item">All Messages</a>
                                <a href="https://onlineauctionscript.digisamaritan.com/messenger/inbox" class="list-group-item ">
                    Inbox
                    
                </a>
                <a href="https://onlineauctionscript.digisamaritan.com/messenger/outbox" class="list-group-item">Outbox</a>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="list-group">
                        ...
                        <div class="col-xs-4 col-md-4">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/8" class="">
                                seller@seller.com
                            </a>
                        </div>
                        ...
                        <div class="col-xs-2 text-right">2024-09-25 13:04:49</div>
                        <div class="col-xs-1 text-center">
                            
                                                        <a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="deleteRecord('8')"> Delete </a>
                                                    </div>
                    </div>
                                    <div class="row list-group-item">
                        <div class="col-xs-4 col-md-4">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/7" class="">
                                sai84130@gmail.com
                            </a>
                        </div>
                        <div class="col-xs-5 col-md-5">
                        ...
                        <div class="col-xs-2 text-right">2018-04-11 11:43:07</div>
                        <div class="col-xs-1 text-center">
                                    ...
                                    <div class="row list-group-item">
                        <div class="col-xs-4 col-md-4">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/6" class="">
                        ...
                        <div class="col-xs-2 text-right">2018-04-11 10:43:34</div>
                        <div class="col-xs-1 text-center">
                                    ...
                                    <div class="row list-group-item">
                        <div class="col-xs-4 col-md-4">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/5" class="">
                                johnbidder@gmail.com
                            </a>
                        </div>
                        <div class="col-xs-5 col-md-5">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/5" class="">
                        ...
                        <div class="col-xs-2 text-right">2018-04-03 11:18:47</div>
                        <div class="col-xs-1 text-center">
                                    ...
                                    <div class="row list-group-item">
                        <div class="col-xs-4 col-md-4">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/4" class="">
                                johnbidder@gmail.com
                            </a>
                        </div>
                        <div class="col-xs-5 col-md-5">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/4" class="">
                                Regarding Participate in an auction
                            </a>
                        </div>
                        <div class="col-xs-2 text-right">2018-03-03 01:11:39</div>
                        <div class="col-xs-1 text-center">
                                    ...
                                    <div class="row list-group-item">
                        <div class="col-xs-4 col-md-4">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/3" class="">
                                johnbidder@gmail.com
                            </a>
                        </div>
                        <div class="col-xs-5 col-md-5">
                        ...
                        <div class="col-xs-2 text-right">2018-03-03 00:59:47</div>
                        <div class="col-xs-1 text-center">
                                    ...
                                    <div class="row list-group-item">
                        <div class="col-xs-4 col-md-4">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/1" class="">
                                seller@seller.com
                            </a>
                        </div>
                        <div class="col-xs-5 col-md-5">
                        ...
                        <div class="col-xs-2 text-right">2018-02-06 04:33:05</div>
                        <div class="col-xs-1 text-center">
                                    ...
                                    <div class="row list-group-item">
                        <div class="col-xs-4 col-md-4">
                            <a href="https://onlineauctionscript.digisamaritan.com/messenger/2" class="">
                                seller@seller.com
                            </a>
                        </div>
                        <div class="col-xs-5 col-md-5">
                        ...
                        <div class="col-xs-2 text-right">2018-02-06 04:16:08</div>
                        <div class="col-xs-1 text-center">
                            
                                                        <a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="deleteRecord('2')"> Delete </a>
                                                    </div>
                    </div>
                            </div>
        </div>
