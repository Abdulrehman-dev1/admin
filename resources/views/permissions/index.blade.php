...
<div class="container">
    <div class="row align-items-center mb-3">
        <div class="col">
            <h1 class="h4 mb-0" style="font-weight: 800; color: #1A1D2F;">Permissions Management</h1>
        </div>
        <div class="col-auto">
            <a href="{{ route('permissions.create') }}" class="btn-add-premium">
            ...
            <form id="filterForm" action="{{ route('permissions.index') }}" method="GET">
                <div class="row g-2 mb-3">
                    <div class="col-lg-8 col-md-6">
                        <label class="filter-group-label">Search Permissions</label>
                        <input type="text" name="search" class="form-control nftmax-filter-input" placeholder="Permission Name..." value="{{ request('search') }}" autocomplete="off">
                    </div>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('permissions.index') }}" class="btn btn-filter-reset">Reset Filters</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div id="permissions-table-container">
        <div class="table-responsive">
            @include('permissions.table_partial')
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        const container = $('#permissions-table-container');
        ...
        function fetchPermissions() {
            ...
            const url = "{{ route('permissions.index') }}?" + formData;
