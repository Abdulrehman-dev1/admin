...
<div class="panel-body">
        ...
        <div class="col-md-10"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; inset: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
            <!-- <h2 style="margin-top: 0;">Seller wise Report</h2> -->

            <canvas id="myChart" width="878" height="439" style="display: block; width: 878px; height: 439px;"></canvas>
