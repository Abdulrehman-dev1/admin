...
<div class="container">
    <div class="row align-items-center mb-3">
        <div class="col">
            <h1 class="h4 mb-0" style="font-weight: 800; color: #1A1D2F;">Individual Verifications</h1>
        </div>
    </div>
    ...
    <div class="card nftmax-filter-card">
        <div class="card-body p-3">
            <form id="filterForm" action="{{ route('individual-verifications.index') }}" method="GET">
                <div class="row g-2 mb-3">
                    <div class="col-lg-4 col-md-6">
                        <label class="filter-group-label">Search</label>
                        <input type="text" name="search" class="form-control nftmax-filter-input" placeholder="Name, Email, Phone, ID..." value="{{ request('search') }}" autocomplete="off">
                    </div>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('individual-verifications.index') }}" class="btn btn-filter-reset">Reset Filters</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div id="verifications-table-container">
        <div class="table-responsive">
            @include('individual_verifications.table_partial')
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        function fetchVerifications() {
            ...
            const url = "{{ route('individual-verifications.index') }}?" + formData;
