...
//         $user = Auth::user();
// //dd("rafw",$user);
//         // Fetch all notifications for the user, ordered by the latest.
//         $notifications = $user->NewNotification()->latest()->get();
    ...
    public function deleteNotification($id)
{
    ...
    // Use the correct relationship model (change NewNotification to match your actual model)
